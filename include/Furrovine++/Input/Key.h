...
namespace Furrovine { namespace Input {
	...
	enum class Key {
		...
		Cancel = 0x03,
		MiddleButton = 0x04,
		AuxiliaryButton1 = 0x05,
		AuxiliaryButton2 = 0x06,
		Unassigned0 = 0x07,
		...
		NumpadEnter = 94, // Numeric keypad 9 key
		Multiply = 106, // Multiply key
		NumpadStar = Multiply,
		Add = 107, // Add key
		NumpadPlus = Add,
		Separator = 108, // Separator key
		//NumpadSlash = Separator,
		...
		Semicolon = 186, // Windows 2000/XP: The OEM Semicolon key on a US standard keyboard
		Equals = 187, // Windows 2000/XP: For any country/region, the '+' key
		Comma = 188, // Windows 2000/XP: For any country/region, the ',' key
		OemMinus = 189, // Windows 2000/XP: For any country/region, the '-' key
		Dot = 190, // Windows 2000/XP: For any country/region, the '.' key
		ForwardSlash = 191, // Windows 2000/XP: The OEM question mark key on a US standard keyboard
		Tilde = 192, // Windows 2000/XP: The OEM tilde key on a US standard keyboard
		OpenBrackets = 219, // Windows 2000/XP: The OEM open bracket key on a US standard keyboard
		OemPipe = 220, // Windows 2000/XP: The OEM pipe key on a US standard keyboard
		CloseBrackets = 221, // Windows 2000/XP: The OEM close bracket key on a US standard keyboard
		Quotes = 222, // Windows 2000/XP: The OEM singled/double quote key on a US standard keyboard
		Oem8 = 223, // Used for miscellaneous characters; it can vary by keyboard.
		Backslash = 226, // Windows 2000/XP: The OEM angle bracket or backslash key on the RT 102 key keyboard
