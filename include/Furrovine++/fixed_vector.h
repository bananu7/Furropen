...
namespace Furrovine {
	...
	public:
		...
		fixed_vector( const fixed_vector& mov ) {
			len = 0;
			for ( std::size_t i = 0; i < mov.size( ); ++i )
				push_back( mov[ i ] );
		}
